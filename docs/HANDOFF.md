...
>
> * **Latest released version:** `v11.0.8` (`pyproject.toml`, `src/gitbook_downloader/__init__.py`). [`CHANGELOG.md`](../CHANGELOG.md) — not this file — is the source of truth for what shipped.
